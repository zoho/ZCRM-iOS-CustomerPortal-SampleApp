...
class DetailViewController: UIViewController {
    ...
    func addCollectionView( previousView : UIView ) -> UICollectionView
    {
        ...
        collectionView.contentHeight = CGFloat( 32 * ( productDetails!.count + 7 ) )
        ...
        {
            collectionView.bottomAnchor.constraint( equalTo : collectionView.topAnchor, constant : CGFloat( ( productDetails!.count + 6 ) * 32 ) ).isActive = true
        }
